      ...
      <nav className=" flex justify-between  gap-10 md:py-6 md:flex lg:px-10 ">
        ...
        <div className={` absolute z-50 left-0 top-0 text-black flex justify-start bg-green-600 w-full h-full transition-all duration-1000 ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
          <ul className=' flex flex-col py-28 px-16 lg:px-28 gap-16 text-2xl max-h-screen '>
            ...
            <Link href={"/"} className=' border-b-2 divide-slate-200 transition ease-in-out hover:translate-x-4 hover:scale-110 duration-200 ...'>About</Link>
            ...
            <Link href={"/"} className=' border-b-2 divide-slate-200 transition ease-in-out hover:translate-x-4 hover:scale-110 duration-200 ...'>Contact</Link>
          </ul>
        </div>
